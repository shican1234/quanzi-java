...
import io.renren.common.modules.commodity.excel.CommodityExcel;
...
public class CommodityController {
    ...
    @RequiresPermissions("commodity:commodity:page")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("commodity:commodity:export")
